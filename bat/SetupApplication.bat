...
:: Android packaging
set AND_CERT_NAME="InlineshuffleAIR"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\InlineshuffleAIR.p12
...
set IOS_PROVISION=cert\InlineshuffleAIR.mobileprovision
...
set APP_ID=air.InlineshuffleAIR

:: Output packages
set DIST_PATH=dist
set DIST_NAME=InlineshuffleAIR
